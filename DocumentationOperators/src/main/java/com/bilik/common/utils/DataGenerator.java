...
public class DataGenerator {
    ...
    private static final int SECONDS_BETWEEN_RIDES = 60;
    private static final int NUMBER_OF_DRIVERS = 10;
    public static final Instant BEGINNING = Instant.parse("2022-12-14T12:00:00.00Z");
    ...
    public long driverId() {
        ...
        return 101 + rnd.nextInt(NUMBER_OF_DRIVERS);
    }
